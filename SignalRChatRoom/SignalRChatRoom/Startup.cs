...
namespace SignalRCahtRoom
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string conectionString = "Data Source=.; Initial Catalog=ChatRoomDb; Persist Security Info=True; User ID=javad; Password=12345678;TrustServerCertificate=True";
